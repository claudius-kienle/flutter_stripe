...
sealed class GooglePayCardToken with _$GooglePayCardToken {
...
sealed class IsCardInWalletResult with _$IsCardInWalletResult {
  @JsonSerializable(explicitToJson: true)
...
sealed class CanAddCardToWalletResult with _$CanAddCardToWalletResult {
  @JsonSerializable(explicitToJson: true)
...
sealed class CanAddCardToDetails with _$CanAddCardToDetails {
  @JsonSerializable(explicitToJson: true)
...
sealed class CanAddCardToWalletParams with _$CanAddCardToWalletParams {
  @JsonSerializable(explicitToJson: true)
