...
@freezed
sealed class CustomerSheetInitParams with _$CustomerSheetInitParams {
...
@freezed
sealed class CustomerSheetPresentParams with _$CustomerSheetPresentParams {
  @JsonSerializable(explicitToJson: true)
...
@freezed
sealed class CustomerSheetResult with _$CustomerSheetResult {
  @JsonSerializable(explicitToJson: true)
