...
@freezed
sealed class SetupPaymentSheetParameters with _$SetupPaymentSheetParameters {
...
@freezed
sealed class IntentConfiguration with _$IntentConfiguration {
  @JsonSerializable(explicitToJson: true)
...
@freezed
sealed class PaymentSheetApplePay with _$PaymentSheetApplePay {
  @JsonSerializable(explicitToJson: true)
...
@freezed
sealed class PaymentSheetGooglePay with _$PaymentSheetGooglePay {
  @JsonSerializable(explicitToJson: true)
...
@freezed
sealed class PaymentSheetAppearance with _$PaymentSheetAppearance {
  @JsonSerializable(explicitToJson: true)
...
@freezed
sealed class PaymentSheetAppearanceColors with _$PaymentSheetAppearanceColors {
...
/// Parameters that change the appearance of the payment sheet.
@freezed
sealed class PaymentSheetShape with _$PaymentSheetShape {
  @JsonSerializable(explicitToJson: true)
...
@freezed
sealed class PaymentSheetShadowParams with _$PaymentSheetShadowParams {
  @JsonSerializable(explicitToJson: true)
...
/// Shadow config parameters
@freezed
sealed class PaymentSheetShadowOffset with _$PaymentSheetShadowOffset {
  @JsonSerializable(explicitToJson: true)
...
@freezed
sealed class PaymentSheetPrimaryButtonAppearance
...
@freezed
sealed class PaymentSheetPrimaryButtonShape
...
@freezed
sealed class PaymentSheetPrimaryButtonTheme
...
@freezed
sealed class PaymentSheetPrimaryButtonThemeColors
...
sealed class PresentPaymentSheetParameters
...
@freezed
sealed class PaymentSheetPresentOptions with _$PaymentSheetPresentOptions {
  @JsonSerializable(explicitToJson: true)
...
@freezed
sealed class PaymentSheetPaymentOption with _$PaymentSheetPaymentOption {
  @JsonSerializable(explicitToJson: true)
...
@freezed
sealed class BillingDetailsCollectionConfiguration
