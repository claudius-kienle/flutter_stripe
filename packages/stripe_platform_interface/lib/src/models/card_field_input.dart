...
sealed class CardStyle with _$CardStyle {
...
/// Styiling information for the cardfield.
sealed class CardFormStyle with _$CardFormStyle {
  @JsonSerializable(explicitToJson: true)
...
sealed class CardPlaceholder with _$CardPlaceholder {
  @JsonSerializable(explicitToJson: true)
...
/// User input details.
sealed class CardFieldInputDetails with _$CardFieldInputDetails {
...
@freezed
sealed class CardFieldFocusName with _$CardFieldFocusName {
  @JsonSerializable(explicitToJson: true)
