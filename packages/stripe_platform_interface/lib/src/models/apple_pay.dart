...
sealed class ApplePayShippingMethod with _$ApplePayShippingMethod {
...
@freezed
sealed class ApplePayPresentParams with _$ApplePayPresentParams {
  @JsonSerializable(explicitToJson: true)
...
@freezed
sealed class ApplePayErrorAddressField with _$ApplePayErrorAddressField {
  @JsonSerializable(explicitToJson: true)
...
sealed class ApplePayContactName with _$ApplePayContactName {
  @JsonSerializable(explicitToJson: true)
...
sealed class ApplePayPostalAddress with _$ApplePayPostalAddress {
  @JsonSerializable(explicitToJson: true)
