...
/// for ACH payment
sealed class CollectBankAccountParams with _$CollectBankAccountParams {
...
/// an payment method
@freezed
sealed class CollectBankAccountPaymentMethodData
...
sealed class VerifyMicroDepositsParams with _$VerifyMicroDepositsParams {
  @JsonSerializable(explicitToJson: true)
