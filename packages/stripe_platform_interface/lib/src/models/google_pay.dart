...
sealed class PresentGooglePayParams with _$PresentGooglePayParams {
...
sealed class GooglePayInitParams with _$GooglePayInitParams {
  @JsonSerializable(explicitToJson: true)
...
sealed class BillingAddressConfig with _$BillingAddressConfig {
  @JsonSerializable(explicitToJson: true)
...
sealed class CreateGooglePayPaymentParams with _$CreateGooglePayPaymentParams {
  @JsonSerializable(explicitToJson: true)
...
@freezed
sealed class IsGooglePaySupportedParams with _$IsGooglePaySupportedParams {
  @JsonSerializable(explicitToJson: true)
